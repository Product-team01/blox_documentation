...
![Alt text](http://52.3.151.236/wp-content/uploads/2023/04/Screenshot-2023-04-06-at-7.44.51-AM.png "a title")
...
![Alt text](https://d1r1e7xjkfj7nz.cloudfront.net/Screenshot%202023-04-06%20at%207.44.51%20AM.png 'a title')
...
A catalog is a collection of datasets and attributes.
![Alt text](https://d1r1e7xjkfj7nz.cloudfront.net/Screenshot%202023-04-06%20at%208.18.59%20AM.png 'a title')
...
1. Select a Catalog Type.
   1. There are 4 pre-set catalog types currently supported in Blox:
      1. Product Catalog
      1. Banner Catalog
      1. Offer Catalog
      1. Documents

**Note:** Catalog type enables Blox to identify the type of incoming data, so that it can be processed accordingly. In addition to these, any other type of catalogs can be uploaded as well which will be processed as is, with no presets.

1. Select a Segment for the Catalog.
   1. Following segments types currently supported in Blox:
      1. Default/No Segment
      1. Fashion
      1. Grocery
      1. Furniture
...
1. It also enables Blox to automatically extract attributes according to the segment type. The default extraction of attributes is only supported if the catalog type is product catalog and the segment type is fashion.
...
![Alt text](https://d1r1e7xjkfj7nz.cloudfront.net/Screenshot%202023-04-06%20at%208.25.01%20AM.png 'a title')
Connector enables you to connect with a data source that is used to fetch data. There are multiple upload methods supported in Blox. Below are some of the supported connectors and how to use them.
...
![Alt text](https://d1r1e7xjkfj7nz.cloudfront.net/Screenshot%202023-04-06%20at%208.26.33%20AM.png 'a title')
...
![Alt text](https://d1r1e7xjkfj7nz.cloudfront.net/Screenshot%202023-04-06%20at%208.28.16%20AM.png 'a title')
Blox identifies the fields(headers) in your catalog automatically. This step enables you to assign attributes and configure the various parameters for each of the fields. Below are some of the settings and how you can configure them.
...
Catalogs can be manually uploaded to Blox. These files can either be in the CSV or JSON formats.

1. Enter the Upload Method Name for the connector
1. Choose the Manual as the Upload method type from the dropdown

**Note**: The configuration fields will be displayed for the Manual upload method.
...
3. Enter the Secret, Token and Key for the S3 bucket

4. Enter the File path.

**Note**: Make sure the file path is publicly accessible.

5. Fill all the mandatory fields for the selected upload method type
