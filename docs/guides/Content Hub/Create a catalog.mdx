...
![Alt text](https://d1r1e7xjkfj7nz.cloudfront.net/catalog2b.png 'a title')
...
![Alt text](https://d1r1e7xjkfj7nz.cloudfront.net/catalog3b.png 'a title')
Connector enables you to connect with a data source that is used to fetch data. There are multiple upload methods supported in Vue. Below are some of the supported connectors and how to use them.
...
![Alt text](https://d1r1e7xjkfj7nz.cloudfront.net/catalog4b.png 'a title')
...
![Alt text](https://d1r1e7xjkfj7nz.cloudfront.net/catalog5b.png 'a title')
