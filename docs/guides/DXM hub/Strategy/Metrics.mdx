...
## Getting to Strategy Listing Screen
 ...
 ![Alt text](https://d1r1e7xjkfj7nz.cloudfront.net/s11.png 'a title')
### Navigation
...
- Select a catalog which will be used to serve recommendation
- Select a Model
...
You can configure content attributes by selecting an attribute and giving a priority score to indicate how important the content attribute is to the model. Model parameters, in the context of content like dresses, may include content attributes such as brand, color, and pattern. Note: The content attributes that are available are the ‘Indexed Fields’ during catalog onboarding in Content Hub.

### Events

You can configure events by selecting the ‘Look Back Period ‘, ‘User Events’ And set priority score for user events
...
- Pageview: On choosing Buy, the model displays products bought by the customer in the last X days.
- Buy: On choosing Pageview, the model displays products viewed by the customer in the last X days.
...
- Apply To (Optional): This option is used to configure, for what content attributes on the source content’s page, the filters conditions need to be applied. Click on ‘Save’ to save the configured business Rule.

**Example of Business Rule Configuration**

Let us take an example for configuring the business rules in an E-commerce website.
...
Note: If you want to retain the configurations made and continue at a later time, click the "Continue Later" button and click on ‘Save & Exit’. The strategy will be created in draft state.
 ...
 ![Alt text](https://d1r1e7xjkfj7nz.cloudfront.net/s22.png 'a title')
...
## Basic Setup
 ...
 ![Alt text](https://d1r1e7xjkfj7nz.cloudfront.net/s33.png 'a title')
...
## Personalization
 ...
 ![Alt text](https://d1r1e7xjkfj7nz.cloudfront.net/s44.png 'a title')
...
## Advanced Setup
 ...
 ![Alt text](https://d1r1e7xjkfj7nz.cloudfront.net/s55.png 'a title')
